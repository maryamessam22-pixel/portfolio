    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="social-icons">
          ...
          <a href="mailto:your@email.com" className="social-icon gmail">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://behance.net/yourprofile" target="_blank" rel="noopener noreferrer" className="social-icon behance">
            <svg viewBox="0 0 24 24" fill="currentColor">
