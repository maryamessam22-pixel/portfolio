    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="social-icons">
         ...
         <a
  href="https://www.upwork.com/freelancers/~0155e845a47587b035"
  target="_blank"
  rel="noopener noreferrer"
  className="social-icon upwork"
>
  <svg viewBox="0 0 24 24" fill="currentColor" aria-label="Upwork">
    <path d="M17.5 6.5c-1.5 0-2.7.9-3.3 2.3-.6-1.3-1.3-2.6-1.9-3.8h-2v5.7c0 1.6-.8 2.7-2.2 2.7s-2.2-1.1-2.2-2.7V5H3.9v5.8c0 2.8 1.8 4.6 4.3 4.6 2.4 0 4.2-1.8 4.2-4.6V9.2c.4.9.8 1.7 1.2 2.5l-1.9 8.3h2.1l1.6-7.1c.4.1.9.2 1.4.2 2.7 0 4.7-1.9 4.7-4.7 0-2.6-1.8-4.6-4-4.6zm-.3 6.3c-.5 0-.9-.1-1.3-.3l.5-2.1c.3-1.3.9-2 1.9-2 1.1 0 1.8.9 1.8 2.1 0 1.4-1 2.3-2.9 2.3z"/>
  </svg>
</a>
